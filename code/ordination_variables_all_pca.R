...
#write.xlsx(as.data.frame(dat.PCA), file = "data/test_PCA_HOS.xlsx", col.names = TRUE, row.names = TRUE, append = FALSE)
...
keep_q     <- 0.75     # e.g., 0.90 to keep arrows >= 90th percentile length
...
# (Optional) quick peek
head(site_scores_all_pca)
head(loadings_all_pca)
var_all_pca
